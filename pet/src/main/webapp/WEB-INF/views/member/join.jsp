...
<div>
	<form id="join_form" name="join_form" method="post" onsubmit="return validateForm()">
		<div>
			<div>
				<span>회원가입</span>
			</div>
			...
			<div style="height:100px; margin-top: 10px;">
				...
				<span class="check_verification_code" style="display: none;">인증번호가 일치하지 않습니다.</span>
				<span class="final_verification_code_ck" style="display: none;">인증이 완료되었습니다.</span>
			</div>
